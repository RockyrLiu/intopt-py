...
class IA:
    """基本免疫算法"""
    def __init__(self, Np, dim, max_iter, mut_prob, simThresh, Ncl, 
                 obj_function, lower_bound, upper_bound, refresh_rate=0.5):
        self.Np = Np # 种群数
        self.dim = dim # 维数
...
def main():
    ...
    ia = IA(Np, dim, max_iter, mut_prob, 0.2, 10, 
            Square, lower_bound=-5.12, upper_bound=5.12, refresh_rate=refresh_rate)
