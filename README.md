...
### 实例
1. SA1.py: minimize $f(x)=3x_1^2-2.1x_1^4+\frac{x_1^6}{3}+x_1x_2-3x_2^2+3x_2^4,\ |x_i|\leq 5$
2. SA2.py: 已知100个目标的经纬度在data\obj_longitude_latitude.txt,我方基地经纬度(70, 40)。现在需要一架飞机从基地出发，侦察完所有目标，返回原基地。求该飞机飞行的最短距离。
...
### 实例
**从0实现的遗传算法**
1. GA1.py: 已知100个目标的经纬度在data\obj_longitude_latitude.txt,我方基地经纬度(70, 40)。现在需要一架飞机从基地出发，侦察完所有目标，返回原基地。求该飞机飞行的最短距离。
2. GA1_ChaosOptimized.py: 在GA2.py的基础上使用混沌序列替代传统随机方法。

更多从0实现的遗传算法实例可参看Clinton Sheppard《Genetic Algorithms with Python》

**基于DEAP框架的遗传算法**
1. GA2.py: 旅行商问题
2. GA3.py: 基于**共享和小生境**的多极值函数优化
3. GA4.py: 含有**限制条件**的函数优化
4. GA1_withDEAP.py: 基于DEAP框架的飞机飞行最短距离求解, **自定义算子算法与DEAP框架的耦合**
